class CarbonMonoxide {
  // In this case this the ANSI codes
  static final String ANSI_CLEAR="\u001B[2J";  // This clears the screen
  static final String ANSI_REPOSITION="\u001B[H";  //then here it goes to the top left
  static final String ANSI_RESET="\u001B[0m";  // Then this will cause it to reset to default color, background
  ...
  public static void main(String[] args) {
    ...
    System.out.println(ANSI_RESET+"Carbon Monoxide Concentrations Across LA County 1/21/2021"); //here we set the spaces equal to the amount that we are given
    System.out.println(ANSI_RESET+"           Azusa"+ANSI_RED_BKGRND+"      "+ANSI_RESET+"0.6"); // Then here is where i typed the code 0.6 = 6 spaces and 0.4 = 4 spaces
